...
namespace GraphSharp.Algorithms.Layout.Simple.Hierarchical
{
        ...
        where TGraph : IVertexAndEdgeListGraph<TVertex, TEdge>
    {
        ...
        /// </summary>
        private readonly IDictionary<TEdge, SKPoint[]> _edgeRoutingPoints =
            new Dictionary<TEdge, SKPoint[]>();

        private readonly IDictionary<TEdge, IList<SugiVertex>> _dummyVerticesOfEdges =
            new Dictionary<TEdge, IList<SugiVertex>>();

        private readonly IDictionary<TVertex, SKSize> _vertexSizes;
        ...
        public IDictionary<TEdge, SKPoint[]> EdgeRoutes
        {
