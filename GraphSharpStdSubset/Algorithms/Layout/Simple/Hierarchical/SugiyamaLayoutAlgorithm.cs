...
namespace GraphSharp.Algorithms.Layout.Simple.Hierarchical
{
        ...
        where TGraph : IVertexAndEdgeListGraph<TVertex, TEdge>
    {
        ...
        */
        ...
        public IDictionary<TEdge, SKPoint[]> EdgeRoutes { get; private set; }

        #region Constructors
        public SugiyamaLayoutAlgorithm(
            TGraph visitedGraph,
            IDictionary<TVertex, SKSize> vertexSizes,
            ...
            : base( visitedGraph, vertexPositions, parameters )
        {
            ...
            EdgeRoutes = new Dictionary<TEdge, SKPoint[]>();
        ...
        /// </summary>
        protected void ConvertGraph( IDictionary<TVertex, SKSize> vertexSizes )
        {
        ...
        protected void ReplaceLongEdges()
        {
            ...
            foreach ( var edge in _graph.HierarchicalEdges.ToArray() )
            {
                ...
                for ( int i = sourceLayerIndex + 1; i <= targetLayerIndex; i++ )
                {
                    ...
                    {
                        dummy = new SugiVertex( null, new SKSize( 0, 0 ) );
        ...
        {
            return Math.Max( 0, ( ( b.Size.Width + a.Size.Width ) * 0.5f + plusGap + Parameters.HorizontalGap ) - ( b.RealPosition.X - a.RealPosition.X ) );
        }
